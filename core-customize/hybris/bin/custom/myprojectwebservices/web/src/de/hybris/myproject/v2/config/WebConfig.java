 ...
 */
package de.hybris.myproject.v2.config;


import de.hybris.platform.servicelayer.config.ConfigurationService;
import de.hybris.platform.webservicescommons.swagger.services.ApiVendorExtensionService;
import de.hybris.myproject.constants.YcommercewebservicesConstants;
import de.hybris.myproject.request.mapping.handler.CommerceHandlerMapping;
...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "myprojectwebservices.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "myprojectwebservices.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "myprojectwebservices.oauth2.tokenUrl";

	private static final String DESC = "myprojectwebservices.v2.description";
	private static final String TITLE = "myprojectwebservices.v2.title";
	private static final String VERSION = "myprojectwebservices.v2.version";
	private static final String LICENSE = "myprojectwebservices.v2.license";
	private static final String LICENSE_URL = "myprojectwebservices.v2.license.url";
	...
	private static final String LEGACY_CONTENT_NEGOTIATION = "myprojectwebservices.content.negotiation.legacy";
